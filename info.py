...
BOT_TOKEN = environ.get('BOT_TOKEN', "6066273912:AAFHKnZy65V9pEpjCKXK2bP56YR2RnFWHBQ")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/be1b09aa1a0992fa8f02f.jpg')).split()
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001907918585')).split()]
